...
import { Mail, Lock, Eye, EyeOff, Loader2, Apple, Sparkles, ArrowRight, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4 md:p-8 relative overflow-hidden font-montserrat">
      ...
      >
        ...
        <div className="flex-1 flex flex-col p-8 md:p-12 lg:p-14 justify-center bg-white relative">
            ...
            {/* Branding - Synchronized with Dashboard Palette */}
            <div className="mb-8">
                 <h1 className="text-[14px] tracking-[0.3em] font-bold">
                    <span className="bg-gradient-to-r from-indigo-600 to-indigo-400 bg-clip-text text-transparent">SMART</span>
                    <span className="text-black opacity-30 font-normal ml-1">FINANCE</span>
                 </h1>
                 <p className="text-[9px] font-bold text-neutral-400 tracking-[0.4em] uppercase mt-1">Executive Terminal</p>
            </div>

            <div className="mb-8">
                <h2 className="text-[32px] font-bold text-black tracking-tighter leading-tight">Welcome Back</h2>
                <p className="text-neutral-400 mt-2 font-medium text-[14px]">Manage your financial future with precision intelligence.</p>
            </div>

            {/* Social Logins - Clean & Modern */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
                <button className="flex items-center justify-center gap-2 py-3 px-4 bg-white border border-neutral-100 rounded-xl hover:bg-neutral-50 transition-all font-semibold text-[11px] text-black shadow-sm">
            ...
            <div className="relative mb-8">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-[0.3em] font-bold text-neutral-300">
                    <span className="bg-white px-5">Internal Credentials</span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="space-y-1.5">
                    ...
                    <div className="relative group/input">
                        ...
                        <input 
                            ...
                            className="w-full bg-neutral-50/80 border border-transparent rounded-xl py-3.5 pl-11 pr-4 outline-none focus:bg-white focus:border-indigo-100 transition-all text-black font-semibold text-[13px] placeholder:text-neutral-300"
                            required
                            autoComplete="email"
                        />
                    </div>
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="relative group/input">
                        ...
                        <input 
                            ...
                            placeholder="••••••••••••"
                            className="w-full bg-neutral-50/80 border border-transparent rounded-xl py-3.5 pl-11 pr-12 outline-none focus:bg-white focus:border-indigo-100 transition-all text-black font-semibold text-[13px] placeholder:text-neutral-300"
                            required
                ...
                <div className="flex items-center justify-between pt-1">
                    <div className="flex items-center gap-2">
                        ...
                        <label className="text-[12px] font-semibold text-black/60 cursor-pointer">Remember Access</label>
                    </div>
                    <button type="button" className="text-[11px] font-bold text-indigo-600 hover:underline tracking-tight">Forgot Key?</button>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                    <button 
                        ...
                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-indigo-100 transition-all transform active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2 text-[13px] group"
                    >
                    ...
                    <button 
                        ...
                        onClick={handleDemo}
                        disabled={isDemoLoading || isLoading}
                        className="bg-white border border-neutral-100 hover:bg-neutral-50 text-black font-bold py-4 rounded-xl transition-all transform active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2 text-[13px] shadow-sm"
                    >
            ...
            {/* Signup footer */}
            <div className="mt-10 text-center border-t border-neutral-50 pt-8 flex items-center justify-center gap-2 opacity-50">
                 <ShieldCheck className="w-4 h-4 text-emerald-500" />
                 <p className="text-[10px] font-bold text-black uppercase tracking-widest">
                    End-to-End Precision Protection
                 </p>
            </div>
        ...
        <div className="hidden lg:block flex-1 relative p-2">
             <div className="w-full h-full rounded-[1.75rem] overflow-hidden relative group shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                    <p className="text-white/40 text-[10px] font-black uppercase tracking-[0.5em] mb-2">Security Node 01</p>
                    <p className="text-white text-[18px] font-bold tracking-tight leading-tight">Secured Financial Gateway for Executive Assets.</p>
                </div>
             </div>
        </div>
