...
export default function LoginPage() {
    ...
    return (
        <div
            className="min-h-screen flex items-center justify-center p-4 md:p-8 relative overflow-hidden font-montserrat"
            style={{
                backgroundImage: "url('/bg-loginpage.jpg')",
        ...
        >
            ...
            {/* MAIN COMPACT CARD - Split Screen Layout */}
            <motion.div
            ...
            >
                ...
                <div className="flex-1 flex flex-col p-6 sm:p-8 md:p-12 lg:p-14 justify-center bg-white relative">
 
                     {/* Branding - Pitch Black */}
                     <div className="mb-8 md:mb-12">
                         <h1 className="text-[13px] sm:text-[14px] tracking-[0.3em] font-medium whitespace-nowrap">
                     ...
                     <div className="mb-6 md:mb-8">
                         <h2 className="text-[24px] xs:text-[28px] sm:text-[32px] font-medium text-black tracking-tighter leading-tight whitespace-nowrap sm:whitespace-normal">Welcome Back</h2>
                         <p className="text-black mt-2 font-medium text-[13px] sm:text-[14px] leading-snug">Manage your financial future with precision intelligence.</p>
                     </div>
 
                     {/* Social Logins */}
                     <div className="grid grid-cols-2 gap-3 mb-8">
                         <button className="flex items-center justify-center gap-2 py-3 px-4 bg-white border border-neutral-100 rounded-xl hover:bg-neutral-50 transition-all font-bold text-[10px] text-black shadow-sm whitespace-nowrap">
                     ...
                     <div className="relative mb-8">
                         ...
                         <div className="relative flex justify-center text-[10px] uppercase tracking-[0.3em] font-bold text-black">
                             <span className="bg-white px-5 whitespace-nowrap">Direct Access</span>
                         </div>
                     </div>
                     ...
                     <form onSubmit={handleSubmit} className="space-y-4">
                         <div className="space-y-1.5">
                             <label className="text-[10px] font-bold text-black ml-1 uppercase tracking-widest whitespace-nowrap">Email Identity</label>
                             <div className="relative group/input">
                                 ...
                                 <input
                                     ...
                                     className="w-full bg-neutral-50/80 border border-neutral-100 rounded-xl py-3.5 pl-11 pr-4 outline-none focus:bg-white focus:border-indigo-100 transition-all text-black font-semibold text-[13px] placeholder:text-neutral-400"
                                     required
                                     autoComplete="email"
                                 />
                             </div>
                         ...
                         <div className="space-y-1.5">
                             <label className="text-[10px] font-bold text-black ml-1 uppercase tracking-widest whitespace-nowrap">Security Password</label>
                             <div className="relative group/input">
                                 ...
                                 <input
                                     ...
                                     placeholder="••••••••••••"
                                     className="w-full bg-neutral-50/80 border border-neutral-100 rounded-xl py-3.5 pl-11 pr-12 outline-none focus:bg-white focus:border-indigo-100 transition-all text-black font-semibold text-[13px] placeholder:text-neutral-400"
                                     required
                         ...
                         <div className="flex items-center justify-between pt-1">
                             <div className="flex items-center gap-2">
                                 ...
                                 <label className="text-[11px] sm:text-[12px] font-bold text-black cursor-pointer whitespace-nowrap">Remember Access</label>
                             </div>
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                            <button
                                ...
                                className="bg-black hover:bg-neutral-900 text-white font-medium py-4 rounded-xl shadow-lg shadow-neutral-100 transition-all transform active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2 text-[13px] group"
                            >
                ...
                {/* RIGHT COLUMN: VISUAL PILLAR WITH THE NEW IMAGE */}
